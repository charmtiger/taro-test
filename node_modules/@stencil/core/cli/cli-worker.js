...
function excludeStaticComponents(doc, hydrateOpts, hydrateResults) {
...
`
    .replace(/\n/g, '')
    .trim();
function addModulePreloads(doc, hydrateOpts, hydrateResults, componentGraph) {
    if (!componentGraph) {
        return false;
    }
...
function removeModulePreloads(doc) {
...
function requireTsConfigFile(diagnostics, prerenderConfigPath) {
    if (!cachedPrerenderConfig) {
        try {
            ...
            delete require.cache[path__default.resolve(prerenderConfigPath)];
