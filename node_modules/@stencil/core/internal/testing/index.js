/*
 Stencil Testing Platform v1.14.0 | MIT Licensed | https://stenciljs.com
 */
'use strict';
...
const getScopeId = (cmp, mode) => 'sc-' + (appData.BUILD.mode && mode && cmp.$flags$ & 32 /* hasMode */ ? cmp.$tagName$ + '-' + mode : cmp.$tagName$);
...
const attachToAncestor = (hostRef, ancestorComponent) => {
    if (appData.BUILD.asyncLoading && ancestorComponent && !hostRef.$onRenderResolve$ && ancestorComponent['s-p']) {
    ...
    if ((appData.BUILD.lazyLoad || appData.BUILD.hydrateServerSide || appData.BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (appData.BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!appData.BUILD.hydrateServerSide && appData.BUILD.shadowDom && appData.BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await Promise.resolve().then(function () { return require('./shadow-css.js'); }).then(m => m.scopeCss(style, scopeId, false));
            }
