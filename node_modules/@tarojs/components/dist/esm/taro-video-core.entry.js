...
const Video = class {
    ...
    render() {
        ...
        return (h(Host, { class: classNames('taro-video-container', {
            ...
            } }, h("div", { class: 'taro-video-toast-volume-grids' }, [...Array(10).keys()].map(() => (h("div", { class: 'taro-video-toast-volume-grids-item' }))))))), h("div", { class: 'taro-video-toast taro-video-toast-progress', ref: dom => {
                if (dom) {
