...
var Slider = /** @class */ (function () {
    ...
    Slider.prototype.render = function () {
        ...
        return (h(Host, { class: 'weui-slider-box' }, h("div", { class: 'weui-slider' }, h("div", { class: 'weui-slider__inner', style: innerStyles, ref: function (c) { return (_this.sliderInsRef = c); } }, h("div", { style: trackStyles, class: 'weui-slider__track' }), h("div", { class: 'weui-slider__handler', style: handlerStyles, onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd }), h("input", { type: 'hidden', name: name, value: val }))), showValue && h("div", { class: 'weui-slider-box__value' }, val)));
    };
