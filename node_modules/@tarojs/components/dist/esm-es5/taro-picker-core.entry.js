...
import { r as registerInstance, h, c as createEvent, H as Host, g as getElement } from './core-42efd82a.js';
import { c as classNames } from './index-be61bb74.js';
import { T as TOP, L as LINE_HEIGHT } from './constant-12ea7a5a.js';
...
var Picker = /** @class */ (function () {
    function Picker(hostRef) {
        ...
        this.getDateSelector = function () {
            ...
            var monthRange = getMonthRange(_start, _end, currentYear)
                .map(function (item) { return item + "\u6708"; });
            var dayRange = getDayRange(_start, _end, currentYear, currentMonth)
                .map(function (item) { return item + "\u65E5"; });
            var renderView = [
...
export { Picker as taro_picker_core };
