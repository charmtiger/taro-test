...
const Image = class {
    ...
    render() {
        ...
        const cls = index.classNames('taro-img', {
            'taro-img__widthfix': mode === 'widthFix'
        });
        const imgCls = index.classNames(`taro-img__mode-${mode.toLowerCase().replace(/\s/g, '')}`, {
