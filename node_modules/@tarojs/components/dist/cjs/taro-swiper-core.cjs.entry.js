...
const Swiper$1 = class {
    ...
    render() {
        const { indicatorDots, indicatorColor, indicatorActiveColor } = this;
        const cls = index$1.classNames(`taro-swiper-${this._id}`, 'swiper-container');
        const paginationCls = index$1.classNames('swiper-pagination', {
            'swiper-pagination-hidden': !indicatorDots,
            'swiper-pagination-bullets': indicatorDots
        });
        return (core.h("div", { class: cls }, core.h("style", { type: 'text/css' }, `
          ...
          `), core.h("div", { class: 'swiper-wrapper' }, core.h("slot", null)), core.h("div", { class: paginationCls })));
    }
