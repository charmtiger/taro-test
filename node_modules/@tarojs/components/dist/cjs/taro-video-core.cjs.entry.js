...
const utils = require('./utils-d5803274.js');
...
const Video = class {
    constructor(hostRef) {
        ...
        this.analyseGesture = (e) => {
            ...
            if (this.gestureType === 'none') {
                // 两点间距离
                const dist = utils.calcDist(distX, distY);
                // 没有移动
                if (dist < 10)
                    return obj;
            ...
            obj.dataX = utils.normalizeNumber(distX / 200);
            obj.dataY = utils.normalizeNumber(distY / 200);
            return obj;
        };
        this.handlePlay = () => {
            this.isPlaying = true;
        ...
        this.handleTimeUpdate = utils.throttle(async (e) => {
            var _a, _b;
    ...
    async onDocumentTouchMove(e) {
        ...
        if (gestureObj.type === 'adjustVolume') {
            ...
            const duration = this.duration || this._duration;
            this.toastProgressTitleRef.innerHTML = `${utils.formatTime(this.nextPercentage * duration)} / ${utils.formatTime(duration)}`;
    ...
    render() {
        ...
        const durationTime = utils.formatTime(duration || _duration || null);
        return (core.h(core.Host, { class: index$1.classNames('taro-video-container', {
            ...
            } }, core.h("div", { class: 'taro-video-toast-volume-grids' }, [...Array(10).keys()].map(() => (core.h("div", { class: 'taro-video-toast-volume-grids-item' }))))))), core.h("div", { class: 'taro-video-toast taro-video-toast-progress', ref: dom => {
                if (dom) {
