...
const PullToRefresh = class {
    ...
    render() {
        const renderRefresh = (cls) => {
            ...
            const cla = index.classNames(cls, !dragOnEdge && `${prefixCls}-transition`);
        ...
        return (core.h(core.Host, { class: index.classNames(this.prefixCls, `${this.prefixCls}-down`) }, renderRefresh(`${this.prefixCls}-content`)));
    }
